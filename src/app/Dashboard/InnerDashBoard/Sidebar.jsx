...
function Sidebar({ sidebarOpen, refs, tooglesidebar, user }) {
  return (
    <div className={`${sidebarOpen ? "lg:w-64" : ""} z-50`}>
      ...
      >
        <aside className="w-64 noscrollbar overflow-y-auto bg-[#440129] bg-opacity-90 backdrop-blur-sm text-white p-6 border border-white border-opacity-20 shadow-lg h-full">
          <button
